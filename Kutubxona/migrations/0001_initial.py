    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(to='Kutubxona.author')),
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Kutubxona.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BookCopy',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_copy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Kutubxona.bookcopy')),
            ],
        ),
    ]
